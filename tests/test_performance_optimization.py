...
import time
import pytest
from gui.cache_manager import CacheEntry, CacheManager
from gui.performance_monitor import PerformanceMetric, PerformanceMonitor
        import shutil
        import shutil
...
class TestPerformanceMonitor:
    ...
    def test_operation_failure_tracking(self):
        ...
        self.monitor.end_operation(
            "test_operation", success=False, error_message="Test error"
        )
