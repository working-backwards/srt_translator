...
from PySide6.QtWidgets import (
    ...
    QSizePolicy, QHeaderView, QComboBox, QLineEdit, QDialog,
...
class BusinessGlossaryEditor(QWidget):
    ...
    def remove_selected_term(self):
        ...
        term_count = sum(1 for lang_gloss in self.glossary.values() 
                        if english_term in lang_gloss)
    ...
    def _update_term_translations(self, english_term: str, translations: Dict[str, str]):
...
class AddTermDialog(QDialog):
    ...
    def validate_input(self):
        ...
        has_translations = any(
            self.translations[lang].text().strip() 
...
class EditTermDialog(QDialog):
    ...
    def __init__(self, english_term: str, current_translations: Dict[str, str], 
                 languages: List[str], parent=None):
        super().__init__(parent)
