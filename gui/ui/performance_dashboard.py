...
class PerformanceDashboard(QWidget):
    ...
    def __init__(self, performance_monitor: PerformanceMonitor, cache_manager: CacheManager, parent=None):
    ...
    def setup_ui(self):
        ...
        self.operations_table.setHorizontalHeaderLabels([
            "Operation", "Count", "Success Rate", "Avg Time (ms)", 
            "Min Time (ms)", "Max Time (ms)", "Errors"
        ])
    ...
    def connect_signals(self):
        ...
        self.performance_monitor.operation_completed.connect(self.on_operation_completed)
    ...
    def update_operations_table(self):
        ...
        try:
            ...
            for row, (operation, stats) in enumerate(operation_stats.items()):
                ...
                # Total count
                self.operations_table.setItem(row, 1, QTableWidgetItem(str(stats.get('total_operations', 0))))
                ...
                self.operations_table.setItem(row, 4, QTableWidgetItem(f"{min_time:.1f}"))
    ...
    def export_metrics(self):
        ...
        try:
            ...
            file_path, _ = QFileDialog.getSaveFileName(
                ...
                "performance_metrics.json", "JSON Files (*.json)"
            )
        ...
        try:
            ...
            if reply == QMessageBox.Yes:
                ...
                QMessageBox.information(self, "History Cleared", 
                                      "Performance history has been cleared.")
