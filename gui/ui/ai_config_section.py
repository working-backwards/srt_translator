...
from PySide6.QtWidgets import (
    ...
    QProgressBar, QDialog, QDialogButtonBox, QTabWidget
)
...
class AIConfigSection(QGroupBox):
    ...
    def connect_signals(self, toggle_callback, generate_callback, edit_callback, regenerate_callback, view_details_callback, help_callback):
...
class EditConfigurationDialog(QDialog):
    ...
    def __init__(self, excluded_terms: list, business_glossary: dict, parent=None, source_lang="EN"):
    ...
    def has_changes(self) -> bool:
        ...
        return (self.terms_editor.is_modified(self.excluded_terms) or 
                self.glossary_editor.is_modified(self.business_glossary)) 