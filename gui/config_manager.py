...
class GUIConfigManager:
    ...
    def __init__(self, settings_manager: SettingsManager):
        ...
        self.DEFAULT_EXCLUDED_TERMS = [
            "API", "CEO", "CFO", "CTO", "HR", "IT", "UI", "UX", "GDPR", "ROI"
        ]
    ...
    def get_business_glossary(self, target_language: str) -> Dict[str, str]:
        ...
        if target_language in ai_business_glossary and ai_business_glossary[target_language]:
            self.logger.info(f"Using AI-generated business glossary for {target_language}")
            ...
            with open(env_file, 'r', encoding='utf-8') as f:
                for line in f:
                    ...
                    if line.startswith('EXCLUDED_TERMS='):
                        ...
                        excluded_terms = [term.strip() for term in terms_str.split(',') if term.strip()]
                        break
    ...
    def get_config_summary(self) -> Dict[str, any]:
        ...
        return {
            ...
            'total_glossary_terms': sum(len(glossary) for glossary in business_glossaries.values()),
