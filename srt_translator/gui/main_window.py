...
""",
    ...
    def _after_eval_finished(self, json_path: str) -> None:
        ...
        # HTML report is already generated by the orchestrator
        # Just enable the button and set the path
        html_path = self._last_eval_json.with_suffix(".html")
        self._last_eval_html = html_path
        self.translation_section.open_html_btn.setEnabled(True)
        self.logger.info(f"HTML report available: {html_path}")
