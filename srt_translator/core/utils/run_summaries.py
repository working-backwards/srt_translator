...
def create_manifest_summary(
    ...
    *,
    source_language: Optional[Dict[str, Any]] = None,
) -> Dict[str, Any]:
    """
    ...
    return {
        ...
        "source_language": {
            "detected_code": (source_language or {}).get("detected_code"),
            "normalized_code": (source_language or {}).get("normalized_code"),
            "normalized_name": (source_language or {}).get("normalized_name"),
            "confidence": (source_language or {}).get("confidence"),
            "mixed": (source_language or {}).get("mixed"),
        },
        "summary": summary,
        ...
        "artifacts": {
            ...
            "termbase": {
                ...
                "collisions_resolved": len(
                    tb_meta["filtered_for_translation"]["collisions_removed"]
                ),
                "lang": tb_meta["lang"],
            },
...
def create_batch_manifest(
    ...
    *,
    ...
    """Batch-root manifest with high-level info across all languages."""
    normalized_langs = [normalize_language_code(lang) for lang in target_languages]
    return {
        "version": version,
        "timestamp": timestamp,
