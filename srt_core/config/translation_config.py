...
class TranslationConfig:
    ...
    @classmethod
    def from_dict(cls, data: dict, logger: Optional[logging.Logger] = None) -> 'TranslationConfig':
...
def build_config_from_gui(settings_manager) -> TranslationConfig:
    ...
    return TranslationConfig(
        ...
        output_directory=settings_manager.load_last_output_directory() or 'translated_srt_files'
    )
