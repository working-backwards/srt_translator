...
description: Free MIT-licensed SRT translation tool for content creators and developers.
---
...
1. **Download** a packaged build for your platform
...
- **Developers**: Install from source with `pip install -e .`
- **CLI Only**: Lightweight installation without GUI dependencies
